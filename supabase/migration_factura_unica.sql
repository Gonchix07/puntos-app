-- ============================================================
--  Migración: número de factura único en las cargas de puntos
--  Ejecutar en Supabase SQL Editor sobre la base de puntos-app.
--
--  Nota: si ya cargaste facturas repetidas de prueba, primero
--  resolvé los duplicados o la creación del índice va a fallar. Para
--  detectarlos:
--    select factura_numero, count(*) from public.cargas
--    where factura_numero is not null
--    group by factura_numero having count(*) > 1;
-- ============================================================

-- Índice único (los null no cuentan -> la factura sigue siendo opcional)
...
-- Función de carga con validación de factura duplicada
